...
ART = {
 ...
 # the national online practice
 "online-therapy": ("video-call", 800, 619, "A therapy session happening over a video call"),
 "city-page": ("talking-on-the-phone", 743, 743, "Someone talking to their therapist from home"),
}
...
def city_page(c):
    ...
    conds = "\n".join(
        f'      <a class="link-card card-ill fade-up" href="/{slug}">'
        f'<div class="card-art">{art(slug, prefix)}</div><div class="card-txt">'
...
<header class="page-hero">
  <div class="ph-inner with-art">
    ...
    <div class="ph-art">{art('city-page', prefix, lazy=False)}</div>
  </div>
</header>
<section>
  <div class="section-inner">
...
<header class="page-hero">
  <div class="ph-inner with-art">
    ...
    <div class="ph-art">{art('online-therapy', prefix, lazy=False)}</div>
  </div>
</header>
<section>
  <div class="section-inner">
