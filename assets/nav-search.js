...
(function () {
  ...
  css.textContent = [
    ...
    ".ns-close:hover{color:var(--teal-dark,#0f7480);border-color:var(--teal,#0f9aa8)}",
    ...
    ".ns-item:hover .ns-t,.ns-item.is-active .ns-t{color:var(--teal-dark,#0f7480)}",
    ...
    "color:var(--teal-dark,#0f7480);font-size:.86rem;font-weight:600;text-decoration:none}",
